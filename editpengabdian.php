  ...
  require 'database.php';
    ...
    if (!empty($_POST)) {
        ...
        if ($valid) {
              ...
              $sql = "UPDATE pengabdian set judul = ?, nama_dosen = ?, tahun = ?, sumber_dana = ? WHERE id = ?";
              $q = $pdo->prepare($sql);
        ...
        $pdo = Database::connect();
        $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM pengabdian where id = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($id));
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel-body">
                        ...
                        <div class="row">
            <div class="col-md-8">
                <form name="sentMessage" id="contactForm" action="editpengabdian.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
