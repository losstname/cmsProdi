...
$username = $_SESSION['user'];
    ...
    if ( !empty($_POST)) {
        ...
        $sql = "DELETE FROM post_materi  WHERE id = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($id));
        Database::disconnect();
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Hapus Materi</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <form name="sentMessage" id="contactForm" action="deletemateri.php" method="post">
                                    ...
                                    <a href="materikuliah.php"><button type="button" class="btn btn-secondary" id="No">No</button></a>
