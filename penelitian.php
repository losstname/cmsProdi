            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel-body">
                        <a href="tambahpenelitian.php"><i class="fa fa-plus fa-fw"></i> Tambah Penelitian</a><br><br>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach ($pdo->query($sql) as $row) {
                                            ...
                                            echo '<td class="center"><a href="editpenelitian.php?id='.$row['id'].'"><i class="fa fa-edit fa-fw"></i>Edit</a><a href="deletepenelitian.php?id='.$row['id'].'"><i class="fa fa-close fa-fw"></i>Hapus</a></td>';
                                            echo '</tr>';
                                        }
                                    ?>
                                </tbody>
