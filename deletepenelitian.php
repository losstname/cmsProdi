...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Hapus Penelitian</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <form name="sentMessage" id="contactForm" action="deletepenelitian.php" method="post">
                                    <div class="control-group form-group">
                                        <div class="controls">
                                            <input type="hidden" name="id" value="<?php echo $id;?>"/>
                                            <p >Anda yakin ingin menghapus penelitian ini?</p>
                                        </div>
                                    </div>
                                    <div id="success"></div>
                                    <!-- For success/fail messages -->
                                    <button type="submit" class="btn btn-primary" id="Save">Yes</button>
                                    <a href="penelitian.php"><button type="button" class="btn btn-secondary" id="No">No</button></a>
