...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Angkatan</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <form name="sentMessage" id="contactForm" method="post" enctype="multipart/form-data" novalidate>
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="number" class="form-control" id="name" name="name" required data-validation-required-message="Please enter your name.">
    ...
    require 'database.php';
          ...
          if ($valid) {
            if($picture != null){
              ...
              $sql = "INSERT INTO profil_angkatan (Angkatan,Deskripsi,gambar) values(?, ?, ?)";
              $q = $pdo->prepare($sql);
              $q->execute(array($name,$message,$picture));
              ...
              echo $picture;
              $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
              $sql = "INSERT INTO profil_angkatan (Angkatan,Deskripsi) values(?, ?, ?, ?, ?)";
              $q = $pdo->prepare($sql);
              $q->execute(array($name,$message));
              Database::disconnect();
            }

            echo "<script> location.replace('angkatan.php'); </script>";
          }
	}
?>
