...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Dokumentasi</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="panel-body">
                        <a href="tambahdokumentasi.php"><i class="fa fa-plus fa-fw"></i> Tambah Dokumentasi</a><br><br>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach ($pdo->query($sql) as $row) {
                                            ...
                                            echo '<td class="center"><a href="editdokumentasi.php?id='.$row['id'].'"><i class="fa fa-edit fa-fw"></i>Edit</a><a href="deletedokumentasi.php?id='.$row['id'].'"><i class="fa fa-close fa-fw"></i>Hapus</a></td>';
                                            echo '</tr>';
                                        }
                                    ?>
                                </tbody>
