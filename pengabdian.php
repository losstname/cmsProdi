...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pengabdian</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel-body">
                        <a href="tambahpengabdian.php"><i class="fa fa-plus fa-fw"></i> Tambah Pengabdian</a><br><br>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach ($pdo->query($sql) as $row) {
                                            ...
                                            echo '<td class="center"><a href="editpengabdian.php?id='.$row['id'].'"><i class="fa fa-edit fa-fw"></i>Edit</a><a href="deletepengabdian.php?id='.$row['id'].'"><i class="fa fa-close fa-fw"></i>Hapus</a></td>';
                                            echo '</tr>';
                                        }
                                    ?>
                                </tbody>
